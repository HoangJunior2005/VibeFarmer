...
public class InventoryManager : SingletonMonobehaviour<InventoryManager>
{
    ...
    /// <summary>
    /// A�ade item al final del inventario
    /// </summary>
    ...
    public string GetItemTypeDescription(ItemType itemType)
    {
        ...
        switch (itemType)
        {
            case ItemType.Hoeing_tool:
                itemTypeDescription = "Cuốc";
                break;
            case ItemType.Chopping_tool:
                itemTypeDescription = "Rìu";
                break;
            case ItemType.Breaking_tool:
                itemTypeDescription = "Cuốc chim";
                break;
            case ItemType.Reaping_tool:
                itemTypeDescription = "Liềm";
                break;
            case ItemType.Watering_tool:
                itemTypeDescription = "Bình tưới";
                break;
            default:
    ...
    /// <summary>
    /// A�ade item al inventario seleccionado
    /// </summary>
    /// <param name="inventoryLocation">tipo de inventario, 0 - Jugador, 1 - Cofre</param>
    /// <param name="item"> Item a a�adir al inventario seleccionado</param>
    ...
    /// <summary>
    /// A�ade cantidad de dinero indicada al monedero
    /// </summary>
    /// <param name="money">cantidad dinero a a�adir (>0) </param>
    ...
    /// <summary>
    /// Fuerza la actualizacion del inventario peque�o del jugador
    /// </summary>
